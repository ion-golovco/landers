...
function draw() {
    ...
    if (stageClick == 0) {
        ...
        for (let tile of tilesClass) {
            ...
            else if (tile.i == "Forest") { image(i5, tile.x, tile.y, w, h) }
            else if (tile.i == "Water") { image(i6, tile.x, tile.y, w, h) }
            else if (tile.i == "Mountain") { image(i4, tile.x, tile.y, w, h) }
        }
        //Tiles index
        fill(200)
        textSize(8)
